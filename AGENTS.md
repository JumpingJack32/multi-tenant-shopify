...
- **Stripe Checkout Sessions migration planned** — Replace `PaymentIntent + Elements` with hosted Checkout Sessions via Adapter Pattern (`docs/superpowers/specs/2026-07-19-stripe-checkout-sessions-migration.md`). Customer Portal for saved cards is a future step.
